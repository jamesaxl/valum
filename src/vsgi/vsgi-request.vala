...
namespace VSGI {
	...
	public class Request : Object {
		...
		public Request (IOStream connection, string method, Soup.URI uri, HashTable<string, string>? query = null) {
		...
		public Request.with_method (string method, Soup.URI uri) {
			base (connection: new AutoCloseIOStream (new MemoryInputStream (), new MemoryOutputStream.resizable ()),
			      method:     method,
			      uri:        uri);
		}
		...
		public Request.from_cgi_environment (IOStream connection, string[] environment) {
			base (connection:        connection,
